...
insert ignore into posts_tags (post_id, tag_id) values (2, 14);
...
insert ignore into posts_tags (post_id, tag_id) values (13, 12);
...
insert ignore into posts_tags (post_id, tag_id) values (4, 8);
insert ignore into posts_tags (post_id, tag_id) values (2, 3);
